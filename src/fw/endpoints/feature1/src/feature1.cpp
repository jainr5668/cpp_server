...
public:
   ...
   std::vector<Route> getRoutes()
   {
      ...
      // routes.push_back(Route{"/1/:id", RouteMethod::GET, false, std::function<void(RouteContext)>(std::bind(&F123::getPerson, this, std::placeholders::_1))});
      // routes.push_back(Route{"/1", RouteMethod::POST, false, std::function<void(RouteContext)>(std::bind(&F123::addPerson, this, std::placeholders::_1))});
      // routes.push_back(Route{"/1", RouteMethod::GET, true, std::function<void(RouteContext)>(std::bind(&F123::getPersons, this, std::placeholders::_1))});
      return routes;
   }
